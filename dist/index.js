              ...
              /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(
                "div",
                {
                  ...
                  children: [
                    ...
                    tab.checked !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime39.jsx)(
                      "span",
                      {
                        className: (0, import_clsx34.default)(
...
var sidebarTabs = {
  ...
  upsells: {
    id: "upsells",
    label: "Upsells",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiCashMultiple, size: 1 })
  },
  checkIn: {
    id: "check-in",
    label: "Check-in",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiLogin, size: 1 })
  },
  checkout: {
    id: "checkout",
    label: "Checkout",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiLogout, size: 1 })
  },
  messages: {
    id: "messages",
    label: "Messages",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiMessageProcessingOutline, size: 1 })
  },
  calls: {
    id: "calls",
    label: "Calls",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiPhoneOutline, size: 1 })
  },
  digitalTips: {
    id: "digital-tips",
    label: "Digital Tips",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiCurrencyUsd, size: 1 })
  },
  authorizations: {
    id: "authorizations",
    label: "Authorizations",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiShieldCheckOutline, size: 1 })
  },
  contracts: {
    id: "contracts",
    label: "Contracts",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiFileSign, size: 1 })
  },
  idVerification: {
    id: "id-verification",
    label: "ID Verification",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiAccountCheckOutline, size: 1 })
  },
  clientsOnFile: {
    id: "clients-on-file",
    label: "Clients on File",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiAccountBoxOutline, size: 1 })
  },
  amenities: {
    id: "amenities",
    label: "Amenities",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiStoreOutline, size: 1 })
  },
  paymentLinks: {
    id: "payment-links",
    label: "Payment Links",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiCreditCardOutline, size: 1 })
  },
  settings: {
    id: "settings",
    label: "Settings",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiCogOutline, size: 1 })
  },
  // Settings Tabs
  propertyInfo: {
    id: "property-info",
    label: "Property Info",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiHomeOutline, size: 1 })
  },
  branding: {
    id: "branding",
    label: "Branding",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiPaletteOutline, size: 1 })
  },
  billingPayment: {
    id: "billing-payment",
    label: "Billing & Payment",
  ...
  staffMembers: {
    id: "staff-members",
    label: "Staff Members",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiAccountGroupOutline, size: 1 })
  },
  security: {
    id: "security",
    label: "Security",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiShieldAccountOutline, size: 1 })
  },
  pms: {
    id: "pms",
    label: "PMS",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiPuzzleOutline, size: 1 })
  },
  devices: {
    id: "devices",
    label: "Devices",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiTabletCellphone, size: 1 })
  },
  compendium: {
    id: "compendium",
    label: "Compendium",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiNewspaperVariantOutline, size: 1 })
  },
  areaInfo: {
    id: "area-info",
    label: "Area Info",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiMapMarker, size: 1 })
  },
  chat: {
    id: "chat",
    label: "Chat",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiChatOutline, size: 1 })
  },
  // Custom/Above-Property Tabs
  insights: {
    id: "insights",
    label: "Insights",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiChartLine, size: 1 })
  },
  properties: {
    id: "properties",
    label: "Properties",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiDomain, size: 1 })
  },
  analytics: {
    id: "analytics",
    label: "Analytics",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiChartBar, size: 1 })
  },
  surveys: {
    id: "surveys",
    label: "Surveys",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiPoll, size: 1 })
  },
  dashboard: {
    id: "dashboard",
    label: "Dashboard",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiViewDashboard, size: 1 })
  },
  tasks: {
    id: "tasks",
    label: "Tasks",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiClipboardList, size: 1 })
  },
  calendar: {
    id: "calendar",
    label: "Calendar",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiCalendar, size: 1 })
  },
  reports: {
    id: "reports",
    label: "Reports",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiNotebook, size: 1 })
  },
  performance: {
    id: "performance",
    label: "Performance",
    icon: /* @__PURE__ */ (0, import_jsx_runtime41.jsx)(import_react40.default, { path: import_js14.mdiTrendingUp, size: 1 })
  }
};
