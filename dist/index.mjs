...
function CloseIcon({ size }) {
  return /* @__PURE__ */ jsxs25("svg", { width: size, height: size, viewBox: "0 0 20 20", fill: "none", children: [
    /* @__PURE__ */ jsx26("circle", { cx: "10", cy: "10", r: "10", fill: "rgba(0,0,0,0.1)" }),
    /* @__PURE__ */ jsx26(
      "path",
      {
...
function CanaryChip({
  ...
  return /* @__PURE__ */ jsxs25(
    "div",
    {
      ...
      children: [
        !isRemovable && leadingIcon && /* @__PURE__ */ jsx26(
          "span",
          {
        ...
        /* @__PURE__ */ jsx26("span", { className: "flex-1 text-center min-w-0", children: label }),
        !isRemovable && trailingIcon && /* @__PURE__ */ jsx26("span", { className: "flex items-center justify-center shrink-0", children: trailingIcon }),
        isRemovable && !isDisabled && /* @__PURE__ */ jsx26(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsx26(CloseIcon, { size: config.iconSize })
          }
        )
      ]
    }
...
function CanaryTag({
  ...
  return /* @__PURE__ */ jsxs26(
    "div",
    {
      ...
      children: [
        leadingIcon && /* @__PURE__ */ jsx27("div", { className: "w-3 h-3 flex items-center justify-center", style: { color: iconColor }, children: leadingIcon }),
        /* @__PURE__ */ jsx27("span", { children: label }),
        trailingIcon && /* @__PURE__ */ jsx27("div", { className: "w-3 h-3 flex items-center justify-center", style: { color: iconColor }, children: trailingIcon })
      ]
    }
  );
}
...
function CanaryTable({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxs27("div", { className: `w-full p-8 text-center ${className}`, children: [
      /* @__PURE__ */ jsx28("div", { className: "inline-block w-8 h-8 border-4 border-[#2858c4] border-t-transparent rounded-full animate-spin" }),
      /* @__PURE__ */ jsx28("p", { className: "mt-4 text-[14px] text-[#707070]", children: "Loading..." })
    ] });
  }
  if (data.length === 0) {
    return /* @__PURE__ */ jsx28("div", { className: `w-full p-8 text-center ${className}`, children: /* @__PURE__ */ jsx28("p", { className: "text-[14px] text-[#707070]", children: emptyMessage }) });
  }
  return /* @__PURE__ */ jsx28("div", { className: `w-full overflow-x-auto ${className}`, children: /* @__PURE__ */ jsx28("div", { className: "w-full", children: /* @__PURE__ */ jsxs27("table", { className: "w-full border-separate", style: { borderSpacing: 0 }, children: [
    /* @__PURE__ */ jsx28("thead", { children: /* @__PURE__ */ jsx28("tr", { children: columns.map((column) => /* @__PURE__ */ jsx28(
      "th",
      {
        className: clsx25(
    ...
    /* @__PURE__ */ jsxs27("tbody", { children: [
      /* @__PURE__ */ jsx28("tr", { children: /* @__PURE__ */ jsx28("td", { colSpan: columns.length, className: "h-2" }) }),
      data.map((row, rowIndex) => /* @__PURE__ */ jsx28(
        "tr",
        {
          ...
          children: columns.map((column, colIndex) => /* @__PURE__ */ jsx28(
            "td",
            {
              className: clsx25(
                "px-4 py-1 text-[14px]",
...
function CanaryCard({
  ...
  return /* @__PURE__ */ jsxs28(
    "div",
    {
      ...
      onClick,
      children: [
        (title || subtitle) && /* @__PURE__ */ jsxs28("div", { className: clsx26("border-b", paddingClasses[padding]), style: { borderColor: colors.colorBlack6 }, children: [
          title && /* @__PURE__ */ jsx29("h3", { className: "text-[18px] font-semibold", style: { color: colors.colorBlack1 }, children: title }),
          subtitle && /* @__PURE__ */ jsx29("p", { className: "text-[14px] mt-1", style: { color: colors.colorBlack3 }, children: subtitle })
        ] }),
        /* @__PURE__ */ jsx29("div", { className: paddingClasses[padding], children }),
        footer && /* @__PURE__ */ jsx29(
          "div",
          {
            className: clsx26("border-t", paddingClasses[padding]),
...
var CanaryListItem = forwardRef22(
  ({
    ...
    const content = children || /* @__PURE__ */ jsxs29(Fragment5, { children: [
      isDraggable && /* @__PURE__ */ jsx30("div", { className: "flex items-center cursor-grab dragHandle", children: /* @__PURE__ */ jsx30(Icon10, { path: mdiDrag, size: 0.8, color: colors.colorBlack1 }) }),
      icon && /* @__PURE__ */ jsx30("div", { className: "flex items-center", children: icon }),
      leftContent && /* @__PURE__ */ jsx30("div", { className: "flex items-center flex-shrink-0", children: leftContent }),
      /* @__PURE__ */ jsxs29("div", { className: "flex flex-col flex-1 min-w-0 gap-0.5", children: [
        ...
        subtitle && /* @__PURE__ */ jsx30(
          "div",
          {
            className: clsx27("text-xs", !allowTextWrap && "truncate"),
      ...
      rightContent && /* @__PURE__ */ jsx30("div", { className: "flex items-center flex-shrink-0", children: rightContent })
    ] });
    ...
    return /* @__PURE__ */ jsx30(
      "li",
      {
        ...
        className: clsx27("list-none canary-list-item", className),
...
var CanaryList = ({
  ...
  const [internalItems, setInternalItems] = useState15(items || []);
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx31(
      "div",
      {
        ...
        children: loadingContent || /* @__PURE__ */ jsx31("div", { className: "text-sm", style: { color: colors.colorBlack3 }, children: "Loading..." })
      }
    );
  }
  if (hasError) {
    return /* @__PURE__ */ jsx31(
      "div",
      {
        ...
        children: errorContent || /* @__PURE__ */ jsx31("div", { className: "text-sm", style: { color: colors.colorRed1 }, children: "Error loading list" })
      }
    );
  }
  if (isEmpty) {
    return /* @__PURE__ */ jsx31(
      "div",
      {
        ...
        children: emptyContent || /* @__PURE__ */ jsx31("div", { className: "text-sm", style: { color: colors.colorBlack3 }, children: "No items to display" })
      }
    );
  }
  ...
  if (isDraggable && items) {
    return /* @__PURE__ */ jsxs30(
      DndContext,
      {
        ...
        children: [
          /* @__PURE__ */ jsx31(SortableContext, { items: itemIds, strategy: verticalListSortingStrategy, children: /* @__PURE__ */ jsx31(
            "ul",
            {
              className: clsx28(
                "p-0 m-0",
              ...
              children: /* @__PURE__ */ jsx31(AnimatePresence, { children: currentItems.map((item, index) => /* @__PURE__ */ jsx31(
                SortableItem,
                {
          ...
          /* @__PURE__ */ jsx31(DragOverlay, { children: activeId ? /* @__PURE__ */ jsx31(
            "div",
            {
              style: {
                opacity: 0.5,
  ...
  return /* @__PURE__ */ jsx31(
    "ul",
    {
      ...
      children: /* @__PURE__ */ jsx31(AnimatePresence, { children: childArray.map((child, index) => /* @__PURE__ */ jsx31(
        motion.div,
        {
          initial: { opacity: 0, y: -8 },
          animate: { opacity: 1, y: 0 },
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs31(
        "div",
        {
          ...
          children: [
            (title || showCloseButton) && /* @__PURE__ */ jsxs31(
              "div",
              {
                className: "flex items-center justify-between px-6 py-4 shrink-0",
                children: [
                  title && /* @__PURE__ */ jsx34("h2", { className: "text-[20px] font-medium", style: { color: colors.colorBlack1 }, children: title }),
                  showCloseButton && /* @__PURE__ */ jsx34(
                    CanaryButton,
                    {
                      type: "icon_secondary" /* ICON_SECONDARY */,
                      onClick: onClose,
                      icon: /* @__PURE__ */ jsx34("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "currentColor", children: /* @__PURE__ */ jsx34("path", { d: "M15 5L5 15M5 5L15 15", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }) })
                    }
                  )
                ]
              }
            ),
            /* @__PURE__ */ jsx34("div", { className: "px-6 py-4 overflow-y-auto flex-1", children }),
    ...
    "header",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs34("div", { className: "flex items-center gap-2", children: [
          actions,
          reservationStatus && /* @__PURE__ */ jsxs34(
            "button",
            {
          ...
          userProfile && /* @__PURE__ */ jsxs34(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx38("div", { className: "w-8 h-8 rounded-full overflow-hidden bg-gray-200 shrink-0", children: userProfile.avatarUrl ? /* @__PURE__ */ jsx38(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxs34("div", { className: "flex flex-col items-start leading-tight", children: [
                  /* @__PURE__ */ jsx38(
                    "span",
                    {
...
function CanaryAppShell({
  ...
  return /* @__PURE__ */ jsxs35("div", { className: clsx34("flex h-screen min-h-screen w-full overflow-hidden", className), children: [
    !hideSidebar && /* @__PURE__ */ jsx39(
      CanarySidebar,
      {
    ...
    /* @__PURE__ */ jsxs35("div", { className: "flex flex-col flex-1 min-w-0 overflow-hidden", children: [
      !hideHeader && /* @__PURE__ */ jsx39(
        CanaryPageHeader,
        {
          propertyName,
          onPropertyClick,
...
function CanaryTabs({
  ...
  var _a, _b;
  const [activeTab, setActiveTab] = useState17(defaultTab || ((_a = tabs[0]) == null ? void 0 : _a.id));
  const [pressedTab, setPressedTab] = useState17(null);
  const [hoveredTab, setHoveredTab] = useState17(null);
          ...
          children: tabs.map((tab) => {
            ...
            return /* @__PURE__ */ jsxs36(
              "button",
              {
                ...
                children: [
                  tab.icon && /* @__PURE__ */ jsx40("span", { children: tab.icon }),
                  /* @__PURE__ */ jsx40("span", { children: tab.label })
                ]
              },
              tab.id
            );
...
function CanaryHeader({
  ...
  return /* @__PURE__ */ jsxs37(
    "header",
    {
      ...
      children: [
        (logo || title) && /* @__PURE__ */ jsxs37("div", { className: "flex items-center gap-3", children: [
          logo && /* @__PURE__ */ jsx41("div", { className: "shrink-0", children: logo }),
          title && /* @__PURE__ */ jsx41("h1", { className: "text-[20px] font-semibold", style: { color: colors.colorBlack1 }, children: title })
        ] }),
        navigation && /* @__PURE__ */ jsx41("nav", { className: "flex-1 flex items-center justify-center px-6", children: navigation }),
        actions && /* @__PURE__ */ jsx41("div", { className: "flex items-center gap-2 ml-auto", children: actions })
      ]
    }
  );
}
...
function CanaryToast({
  ...
  const [visible, setVisible] = useState18(isOpen);
  useEffect8(() => {
    setVisible(isOpen);
  ...
  return /* @__PURE__ */ jsxs38(
    "div",
    {
      ...
      children: [
        icon && /* @__PURE__ */ jsx43("div", { className: "shrink-0", children: icon }),
        /* @__PURE__ */ jsx43("p", { className: "text-[14px] font-medium flex-1", children: message }),
        /* @__PURE__ */ jsx43(
          "button",
          {
            onClick: handleClose,
...
function CanaryAlert({
  ...
  return /* @__PURE__ */ jsxs39(
    "div",
    {
      ...
      children: [
        icon && /* @__PURE__ */ jsx44("div", { className: "shrink-0 mt-0.5", children: icon }),
        /* @__PURE__ */ jsxs39("div", { className: "flex-1", children: [
          title && /* @__PURE__ */ jsx44("h4", { className: "text-[14px] font-semibold mb-1", children: title }),
          /* @__PURE__ */ jsx44("p", { className: "text-[14px]", children: message })
        ] }),
