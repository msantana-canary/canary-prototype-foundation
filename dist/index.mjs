          ...
          children: [
            (title || showCloseButton) && /* @__PURE__ */ jsxs30(
              "div",
              {
                ...
                style: { borderColor: colors.colorBlack6 },
                children: [
                  title && /* @__PURE__ */ jsx33("h2", { className: "text-[20px] font-semibold", style: { color: colors.colorBlack1 }, children: title }),
...
var sidebarTabs = {
  ...
  upsells: {
    id: "upsells",
    label: "Upsells",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiCashMultiple3, size: 1 })
  },
  checkIn: {
    id: "check-in",
    label: "Check-in",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiLogin3, size: 1 })
  },
  checkout: {
    id: "checkout",
    label: "Checkout",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiLogout3, size: 1 })
  },
  messages: {
    id: "messages",
    label: "Messages",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiMessageProcessingOutline3, size: 1 })
  },
  calls: {
    id: "calls",
    label: "Calls",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiPhoneOutline3, size: 1 })
  },
  digitalTips: {
    id: "digital-tips",
    label: "Digital Tips",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiCurrencyUsd3, size: 1 })
  },
  authorizations: {
    id: "authorizations",
    label: "Authorizations",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiShieldCheckOutline3, size: 1 })
  },
  contracts: {
    id: "contracts",
    label: "Contracts",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiFileSign2, size: 1 })
  },
  idVerification: {
    id: "id-verification",
    label: "ID Verification",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiAccountCheckOutline3, size: 1 })
  },
  clientsOnFile: {
    id: "clients-on-file",
    label: "Clients on File",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiAccountBoxOutline2, size: 1 })
  },
  amenities: {
    id: "amenities",
    label: "Amenities",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiStoreOutline2, size: 1 })
  },
  paymentLinks: {
    id: "payment-links",
    label: "Payment Links",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiCreditCardOutline5, size: 1 })
  },
  settings: {
    id: "settings",
    label: "Settings",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiCogOutline3, size: 1 })
  },
  // Settings Tabs
  propertyInfo: {
    id: "property-info",
    label: "Property Info",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiHomeOutline3, size: 1 })
  },
  branding: {
    id: "branding",
    label: "Branding",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiPaletteOutline3, size: 1 })
  },
  billingPayment: {
    id: "billing-payment",
    label: "Billing & Payment",
  ...
  staffMembers: {
    id: "staff-members",
    label: "Staff Members",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiAccountGroupOutline3, size: 1 })
  },
  security: {
    id: "security",
    label: "Security",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiShieldAccountOutline3, size: 1 })
  },
  pms: {
    id: "pms",
    label: "PMS",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiPuzzleOutline3, size: 1 })
  },
  devices: {
    id: "devices",
    label: "Devices",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiTabletCellphone3, size: 1 })
  },
  compendium: {
    id: "compendium",
    label: "Compendium",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiNewspaperVariantOutline3, size: 1 })
  },
  areaInfo: {
    id: "area-info",
    label: "Area Info",
  ...
  insights: {
    id: "insights",
    label: "Insights",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiChartLine2, size: 1 })
  },
  properties: {
    id: "properties",
    label: "Properties",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiDomain, size: 1 })
  },
  analytics: {
    id: "analytics",
    label: "Analytics",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiChartBar, size: 1 })
  },
  surveys: {
    id: "surveys",
    label: "Surveys",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiPoll, size: 1 })
  },
  dashboard: {
    id: "dashboard",
    label: "Dashboard",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiViewDashboard, size: 1 })
  },
  tasks: {
    id: "tasks",
    label: "Tasks",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiClipboardList, size: 1 })
  },
  calendar: {
    id: "calendar",
    label: "Calendar",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiCalendar, size: 1 })
  },
  reports: {
    id: "reports",
    label: "Reports",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiNotebook, size: 1 })
  },
  performance: {
    id: "performance",
    label: "Performance",
    icon: /* @__PURE__ */ jsx41(Icon13, { path: mdiTrendingUp2, size: 1 })
  }
};
