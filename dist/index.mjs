...
function CanaryTabs({
  ...
  var _a, _b;
  const [activeTab, setActiveTab] = useState15(defaultTab || ((_a = tabs[0]) == null ? void 0 : _a.id));
  const [pressedTab, setPressedTab] = useState15(null);
  const [hoveredTab, setHoveredTab] = useState15(null);
  ...
  if (variant === "rounded") {
    return /* @__PURE__ */ jsxs31("div", { className: `w-full ${className}`, children: [
          ...
          children: tabs.map((tab) => {
            ...
            return /* @__PURE__ */ jsxs31(
              "button",
              {
                ...
                children: [
                  tab.icon && /* @__PURE__ */ jsx34("span", { children: tab.icon }),
      ...
      /* @__PURE__ */ jsx34("div", { children: activeTabContent })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs31("div", { className: `w-full ${className}`, children: [
    /* @__PURE__ */ jsx34("div", { className: "flex items-start", children: tabs.map((tab) => {
      const isActive = tab.id === activeTab;
