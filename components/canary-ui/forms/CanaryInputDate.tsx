...
const CanaryInputDate = forwardRef<HTMLDivElement, CanaryInputDateProps>(
  (
    ...
    // Build a Date from current fields for calendar value
    ...
    return (
      <div className={clsx("w-full", className)} ref={containerRef}>
        ...
        <div className="relative">
          ...
          >
            <input ref={monthRef} type="text" inputMode="numeric" value={month} onChange={handleMonthChange} onKeyDown={(e) => handleKeyDown(e, "month")} placeholder="MM" disabled={isDisabled} className={clsx("w-8 bg-transparent outline-none border-none text-center placeholder:text-gray-400", isDisabled && "cursor-not-allowed")} aria-label="Month" />
            <span className="text-gray-500 select-none">/</span>
            <input ref={dayRef} type="text" inputMode="numeric" value={day} onChange={handleDayChange} onKeyDown={(e) => handleKeyDown(e, "day")} placeholder="DD" disabled={isDisabled} className={clsx("w-8 bg-transparent outline-none border-none text-center placeholder:text-gray-400", isDisabled && "cursor-not-allowed")} aria-label="Day" />
            <span className="text-gray-500 select-none">/</span>
            <input ref={yearRef} type="text" inputMode="numeric" value={year} onChange={handleYearChange} onKeyDown={(e) => handleKeyDown(e, "year")} placeholder="YYYY" disabled={isDisabled} className={clsx("w-12 bg-transparent outline-none border-none text-center placeholder:text-gray-400", isDisabled && "cursor-not-allowed")} aria-label="Year" />

            {/* Calendar Icon */}
            <div
              className={clsx("ml-auto flex items-center", !isDisabled && "cursor-pointer")}
