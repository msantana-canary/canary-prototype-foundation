...
```bash
npm install git+https://github.com/msantana-canary/canary-prototype-foundation.git#v0.4.4
# or
yarn add git+https://github.com/msantana-canary/canary-prototype-foundation.git#v0.4.4
# or
...
- **v0.4.4** (Latest) - Settings sidebar fix + CLAUDE.md for AI agent scaffolding
